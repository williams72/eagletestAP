...
(function(document, window, $) {
  ...
  (function() {
    ...
    var options = $.extend(true, {}, defaults, {
      ...
      "sDom": '<"dt-panelmenu clearfix container-fluid"<"row "<"col-xs-6 col-md-6 col-lg-6"l><"col-xs-6 col-md-6 col-lg-6"fr>>>t<"dt-panelfooter clearfix"ip>'
      //"sDom": '<"row"<"col-md-6 col-lg-6"><"col-md-6 col-lg-6"fr>>t<"dt-panelfooter clearfix"ip>'
    });
    $('#exampleFixedHeader').dataTable(options);
