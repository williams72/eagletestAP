...
<div class="page">
    ...
    <div class="page-content">
        ...
        <div class="nav-tabs-horizontal nav-tabs-inverse nav-tabs-animate" data-plugin="tabs">
            ...
            <#if taskResult.result.runSummary.compatibility??>
                <li class="nav-item" role="presentation">
            ...
            <#if taskResult.result.runSummary.case??>
                <li class="nav-item" role="presentation">
            ...
            <#if taskResult.result.runSummary.travel??>
                <li class="nav-item" role="presentation">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-8 col-lg-8">
                            ...
                            <table class="table">
                                <thead>
                                <tr>
                                    <th><@spring.message "project.ResultStart"/>（MS）</th>
            ...
            <#if taskResult.result.runSummary.compatibility??>
                <div class="tab-pane animation-scale-up" id="result_jianrong" role="tabpanel">
                    ...
                    <#if taskResult.result.errorSummary.compatibility?? && taskResult.result.errorSummary.compatibility?size gt 0>
                        <h4><i class="icon wb-medium-point"></i>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <#list taskResult.result.errorSummary.compatibility?keys as key>
                                        <tr>
                                            <td>${taskResult.result.errorSummary.compatibility[key].title}</td>
                                            <td>${taskResult.result.errorSummary.compatibility[key].description}</td>
                                            <td>${taskResult.result.errorSummary.compatibility[key].phones?size}</td>
                                            <#list taskResult.result.errorSummary.compatibility[key].phones as phone>
                                                <td>
            ...
            <#if taskResult.result.runSummary.case??>
                <div class="tab-pane animation-scale-up" id="result_jiaoben" role="tabpanel">
                    <h4><i class="icon wb-medium-point"></i> 脚本测试概览</h4>
                    <div class="row">
                        <div class="col-xs-12 col-md-4 col-lg-6">
                            <div class="example">
                    ...
                    <#if taskResult.result.errorSummary.case?? && taskResult.result.errorSummary.case?size gt 0>
                        <h4><i class="icon wb-medium-point"></i> 问题列表</h4>
                        <div class="row">
                            <div class="col-lg-12">
                                <table class="table">
                                    <thead>
                                    ...
                                    <tbody>
                                        <#list taskResult.result.errorSummary.case?keys as key>
                                        <tr>
                                            <td>${taskResult.result.errorSummary.case[key].title}</td>
                                            <td>${taskResult.result.errorSummary.case[key].description}</td>
                                            <td>${taskResult.result.errorSummary.case[key].phones?size}</td>
                                            <#list taskResult.result.errorSummary.case[key].phones as phone>
                                                <td>
                                                    <span class="tag tag-info block m-y-3">${phone.model}</span>
                                                </td>
                                            </#list>
            ...
            <#if taskResult.result.runSummary.travel??>
                <div class="tab-pane animation-scale-up" id="result_bianli" role="tabpanel">
                    ...
                    <#if taskResult.result.errorSummary.travel?? && taskResult.result.errorSummary.travel?size gt 0>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <#list taskResult.result.errorSummary.travel?keys as key>
                                        <tr>
                                            <td>${taskResult.result.errorSummary.travel[key].title}</td>
                                            <td>${taskResult.result.errorSummary.travel[key].description}</td>
                                            <td>${taskResult.result.errorSummary.travel[key].phones?size}</td>
                                            <#list taskResult.result.errorSummary.travel[key].phones as phone>
                                                <td>
                                                    <span class="tag tag-info block m-y-3">${phone.model}</span>
                                                </td>
                                            </#list>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <th><@spring.message "project.PerformanceRAM"/>(KB)</th>
                                <th><@spring.message "project.PerformanceFlow"/>(BYTES)</th>
                                <th><@spring.message "project.PerformanceBattery"/>(MAH)</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th><@spring.message "project.MobilesStart"/>(MS)</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <#if phone.result == "pass">
                                                <span class="tag tag-success">
                                                    <@spring.message "project.MobilesPass"/>
                                                </span>
                                            <#elseif phone.result == "fail">
                                                <span class="tag tag-danger">
                                                    <@spring.message "project.MobilesFail"/>
                                                </span>
                                            <#else >
                                                <span class="tag tag-warning"><@spring.message "project.MobilesNotrun"/></span>
                                            </#if>
                                        </td>
                                        <td>
    ...
    <#if taskResult.result.runSummary.compatibility??>
        var $gailan_jianrong = c3.generate({
            ...
            data: {
                // iris data from R
                columns: [
                    ['<@spring.message "project.report.chart.NotRun"/>', ${taskResult.result.runSummary.compatibility.notRun}],
                    ['<@spring.message "project.report.chart.Fail"/>', ${taskResult.result.runSummary.compatibility.installError + taskResult.result.runSummary.compatibility.runError + taskResult.result.runSummary.compatibility.uninstallError}],
                    ['<@spring.message "project.report.chart.Success"/>', ${taskResult.result.runSummary.compatibility.pass}]
                ],
                type: 'donut',
            },
            color: {
    ...
    <#if taskResult.result.runSummary.case??>
        var $gailan_case = c3.generate({
            ...
            data: {
                // iris data from R
                columns: [
                    ['<@spring.message "project.report.chart.NotRun"/>', ${taskResult.result.runSummary.case.notRun}],
                    ['<@spring.message "project.report.chart.Fail"/>', ${taskResult.result.runSummary.case.installError + taskResult.result.runSummary.case.runError + taskResult.result.runSummary.case.uninstallError}],
                    ['<@spring.message "project.report.chart.Success"/>', ${taskResult.result.runSummary.case.pass}]
                ],
                type: 'donut',
            },
            color: {
    ...
    <#if taskResult.result.runSummary.travel??>
        var $gailan_bianli = c3.generate({
            ...
            data: {
                // iris data from R
                columns: [
                    ['<@spring.message "project.report.chart.NotRun"/>', ${taskResult.result.runSummary.travel.notRun}],
                    ['<@spring.message "project.report.chart.Fail"/>', ${taskResult.result.runSummary.travel.installError + taskResult.result.runSummary.travel.runError + taskResult.result.runSummary.travel.uninstallError}],
                    ['<@spring.message "project.report.chart.Success"/>', ${taskResult.result.runSummary.travel.pass}]
                ],
                type: 'donut',
            },
            color: {
    ...
    <#if taskResult.result.runSummary.compatibility??>
        var $pie_jianrong = c3.generate({
            ...
            data: {
                // iris data from R
                columns: [
                    ['<@spring.message "project.report.chart.pass"/>', ${taskResult.result.runSummary.compatibility.pass}],
                    ['<@spring.message "project.report.chart.run_error"/>', ${taskResult.result.runSummary.compatibility.runError}],
                    ['<@spring.message "project.report.chart.notRun"/>', ${taskResult.result.runSummary.compatibility.notRun}],
                    ['<@spring.message "project.report.chart.install_error"/>', ${taskResult.result.runSummary.compatibility.installError}],
                    ['<@spring.message "project.report.chart.uninstall_error"/>', ${taskResult.result.runSummary.compatibility.uninstallError}]
                ],
                type: 'pie',
            },
            color: {
            ...
            for (var filter in devTermObj[option]) {
                ...
                for (i; i < len; i++) {
                    if (cpyDev[i][option] == filter) {
                        if (cpyDev[i].mtcInstall == 2 && cpyDev[i].uninstall == 2 && cpyDev[i].stability == 2) {
    ...
    <#if taskResult.result.runSummary.case??>
        var $pie_jiaoben = c3.generate({
            ...
            data: {
                // iris data from R
                columns: [
                    ['<@spring.message "project.report.chart.pass"/>', ${taskResult.result.runSummary.case.pass}],
                    ['<@spring.message "project.report.chart.run_error"/>', ${taskResult.result.runSummary.case.runError}],
                    ['<@spring.message "project.report.chart.notRun"/>', ${taskResult.result.runSummary.case.notRun}],
                    ['<@spring.message "project.report.chart.install_error"/>', ${taskResult.result.runSummary.case.installError}],
                    ['<@spring.message "project.report.chart.uninstall_error"/>', ${taskResult.result.runSummary.case.uninstallError}]
                ],
                type: 'pie',
            },
            color: {
    ...
    <#if taskResult.result.runSummary.travel??>
        var $pie_jiaoben = c3.generate({
            ...
            data: {
                // iris data from R
                columns: [
                    ['<@spring.message "project.report.chart.pass"/>', ${taskResult.result.runSummary.travel.pass}],
                    ['<@spring.message "project.report.chart.run_error"/>', ${taskResult.result.runSummary.travel.runError}],
                    ['<@spring.message "project.report.chart.notRun"/>', ${taskResult.result.runSummary.travel.notRun}],
                    ['<@spring.message "project.report.chart.install_error"/>', ${taskResult.result.runSummary.travel.installError}],
                    ['<@spring.message "project.report.chart.uninstall_error"/>', ${taskResult.result.runSummary.travel.uninstallError}]
                ],
                type: 'pie',
            },
            color: {
