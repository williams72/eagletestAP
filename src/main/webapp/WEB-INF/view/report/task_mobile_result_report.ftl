...
<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <div class="navbar-toggler collapsed" data-toggle="collapse">
    ...
    <div class="page-header p-t-10 p-b-10">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="${rc.contextPath}/mainpage" target="_blank"><@spring.message "project.DetailContextPathHome"/></a>
            </li>
            <li class="breadcrumb-item">
                <a href="${rc.contextPath}/project/${currentProject.id}" target="_blank">${currentProject.projectName}</a>
            </li>
                    ...
                    <div class="nav-tabs-horizontal nav-tabs-animate" data-plugin="tabs">
                        ...
                        <div class="tab-content p-t-20">
                            ...
                            <div class="tab-pane animation-scale-up" id="m_r_b_installlog" role="tabpanel">
                                <div class="example" style= "background-color: #526069">
                                    <div class="col-md-12 col-lg-12">
                                        <div class="h-450" style="overflow: auto;">
                                            <div data-role="container" style="min-width: 500px;">
                                                <div data-role="content" style="min-width: 500px; color: #FFFFFF; ">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#phone_select").change(function () {
            ...
            window.location.href = "${rc.contextPath}/project/${currentProject.id}/task/${currentTask.id}/mobile/" + phone_serialNumber + "/report";
        });
