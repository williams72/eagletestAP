    ...
    <div class="page-header p-t-10 p-b-10">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item active">
                <a href="${rc.contextPath}/mainpage" target="_blank"><@spring.message "project.ReportContextpathHome"/></a>
            </li>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="${rc.contextPath}/project/${currentProject.id}/task/${currentTask.id}/mobile/${phone.serial_number}/report" target="_blank">
